...
def BatchGeneration(DataDict: Dict[str, List[str]], DataList: List[Commission], Category="", Genre="", Duration=True):
    DurationList = ["0:30", "1:00", "1:10", "1:20", "1:30", "1:40", "1:45", "2:00", "2:15", "2:30", "2:40", "3:00",
                    "3:20", "4:00",
                    "5:00", "5:20", "6:00", "7:00", "8:00", "9:00", "10:00", "12:00"]
    if Duration:
...
def main():
    ...
    with open(file=PYTHON_FILE_CURRENT_PATH / ".." / "data" / "FilterTranslationData.json", mode="w", encoding="utf-8") as f:
